...
import 'package:ebasket_customer/utils/utils.dart';
import 'package:ebasket_customer/widgets/osm_map_search_place.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        child: Icon(Icons.my_location, color: themeChange.getThem() ? AppThemeData.groceryAppDarkBlue :  AppThemeData.groceryAppDarkBlue),
      ),
    );
  }
