                          ...
                          children: [
                            ...
                            Expanded(
                              child: Row(mainAxisAlignment: Responsive.isMobile(context) ? MainAxisAlignment.start : MainAxisAlignment.end, children: [
                                ...
                                Constant.selectedRole.permission!.firstWhere((element) => element.title == "Customers").isUpdate == false
                                    ? const SizedBox()
                                    : RoundedButtonFill(
                                        isRight: true,
                                ...
                                : DataTable(
                                    ...
                                    columns: [
                                      ...
                                      const DataColumn(
                                          label: SizedBox(
                                        width: 160,
                                        child: TextCustom(title: 'Phone Number'),
                                      )),
                                      DataColumn(
                                          label: SizedBox(
                                    ...
                                    rows: controller.currentPageUser
                                        .map((e) => DataRow(cells: [
                                              ...
                                              DataCell(Row(children: [
                                                ...
                                                spaceW(),
                                                Constant.selectedRole.permission!.firstWhere((element) => element.title == "Customers").isDelete == false
                                                    ? const SizedBox()
                                                    : IconButton(
                                                        onPressed: () {
                                                          if (Constant.isDemo()) {
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    DropdownButtonFormField<BranchModel>(
                                      isExpanded: true,
                                      value: controller.selectBranchCust.value.id == null ? null : controller.selectBranchCust.value,
                                      hint: const TextCustom(title: 'Select Branch'),
                                      onChanged: (BranchModel? newValue) {
                                        controller.selectBranchCust.value = newValue!;
                                        controller.update();
                                      },
                                      decoration: InputDecoration(
