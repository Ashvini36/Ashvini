...
import 'package:scaneats/app/ui/order_details_screen/order_details_screen.dart';
                    ...
                    children: [
                      ...
                      Expanded(
                        child: SingleChildScrollView(
                            child: controller.orderViewType.value == "order" ? const OrderDetailScreen() : controller.drawerItems[controller.selectedDrawerIndex.value].widget),
                      )
                    ],
                  ),
                );
        ...
        drawerOptions.add(GestureDetector(
          onTap: () {
            ...
            if (d.title == 'Items') {
              ...
              if (itemController.selectedScreenIndex.value != 0) {
                itemController.navigateScreen(0);
              }
            }
          },
          child: Padding(
