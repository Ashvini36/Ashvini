...
class DiningTableScreenMobileScreen extends StatelessWidget {
  final DiningTableController controller;
  const DiningTableScreenMobileScreen(this.controller, {super.key});
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        CommonUI.appMoblieUI(context, onSelectBranch: ((V) => controller.getDiningTableData()), onChange: ((v) => controller.getDiningTableData(name: v.toString()))),
