...
class TableOrdersController extends GetxController {
  DashBoardController dashBoardController  = Get.find<DashBoardController>();


  RxString title = "Table Orders".obs;
  @override
  void onInit() {
    super.onInit();
  ...
  Future<void> getTableOrdereData() async {
    isOrderoading.value = true;
    await FireStoreUtils.getAllOrder(role: Constant.orderTypeCustomer).then((value) {
      if (value != null) {
  ...
  searchByName({String name = ''}) async {
    ...
    FireStoreUtils.getAllOrderByName(name, Constant.orderTypeCustomer).then((value) {
      posOrderList.value = value ?? [];
      setPagition(totalItemPerPage.value);
    });
  }
