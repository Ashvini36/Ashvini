...
import 'package:scaneats/app/ui/settings_screen/setting_screen_view/branches_view.dart';
import 'package:scaneats/app/ui/settings_screen/setting_screen_view/company_details_view.dart';
import 'package:scaneats/app/ui/settings_screen/setting_screen_view/currencies_view.dart';
import 'package:scaneats/app/ui/settings_screen/setting_screen_view/item_attribute_view.dart';
import 'package:scaneats/app/ui/settings_screen/setting_screen_view/item_category_view.dart';
import 'package:scaneats/app/ui/settings_screen/setting_screen_view/language_view.dart';
import 'package:scaneats/app/ui/settings_screen/setting_screen_view/payment_view.dart';
import 'package:scaneats/app/ui/settings_screen/setting_screen_view/role_view.dart';
import 'package:scaneats/app/ui/settings_screen/setting_screen_view/tax_view.dart';
import 'package:get/get.dart';
import 'package:scaneats/app/ui/settings_screen/setting_screen_view/them_view.dart';

class SettingsController extends GetxController {
  RxString title = "Settings".obs;

  Rx<SettingsItem> selectSettingWidget = SettingsItem(title: ['Company'], icon: "assets/icons/one.svg", widget: [const CompanyDetailsView()], selectIndex: 0).obs;
