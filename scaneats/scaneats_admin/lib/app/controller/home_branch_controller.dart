...
class HomeBranchController extends GetxController {
  ...
  getCustomerData(Timestamp selectedTime) async {
    ...
    await FireStoreUtils.getAllCustomerByTime(selectedTime).then((userData) async {
  ...
  getSalesRevenueData(Timestamp selectedTime) async {
    revenue.value = 0.0;
    await FireStoreUtils.getAllOrderByTime(selectedTime).then((value) {
