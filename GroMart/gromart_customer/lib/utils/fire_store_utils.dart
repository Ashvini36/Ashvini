...
class FireStoreUtils {
  ...
  static Stream<List<VendorModel>> getAllNearestRestaurant() async* {
    try {
      getNearestVendorController = StreamController<List<VendorModel>>.broadcast();
      List<VendorModel> vendorList = [];
      Query<Map<String, dynamic>> query = fireStore.collection(CollectionName.vendors).where('zoneId', isEqualTo: Constant.selectedZone!.id.toString());
  ...
  static Stream<List<VendorModel>> getAllNearestRestaurantByCategoryId({required String categoryId}) async* {
    try {
