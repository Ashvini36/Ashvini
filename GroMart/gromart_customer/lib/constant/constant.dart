...
class Constant {
  ...
  static const globalUrl = "https://staging.gromartadmin.siswebapp.com/"; //"https://gromart.siswebapp.com/";

  static bool isZoneAvailable = false;
  static ZoneModel? selectedZone;

  static String theme = "theme_1";
  static String mapAPIKey = "AIzaSyAe57IxarCzwr82RyC7-JEgWkOFYgDvO1E";
