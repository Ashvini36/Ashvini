...
import 'package:store/controller/stripe_failed_model.dart';
import 'package:store/models/mid_trans.dart';
import 'package:store/models/orange_money.dart';
import 'package:store/models/payment_model/flutter_wave_model.dart';
import 'package:store/models/payment_model/getPaytmTxtToken.dart';
...
import 'package:store/models/xendit.dart';
import 'package:store/payment/MercadoPagoScreen.dart';
import 'package:store/payment/PayFastScreen.dart';
import 'package:store/payment/midtrans_screen.dart';
import 'package:store/payment/orangePayScreen.dart';
import 'package:store/payment/paystack/pay_stack_screen.dart';
import 'package:store/payment/paystack/pay_stack_url_model.dart';
import 'package:store/payment/paystack/paystack_url_genrater.dart';
import 'package:store/payment/xenditModel.dart';
import 'package:store/payment/xenditScreen.dart';
    ...
    await FireStoreUtils.getPaymentSettingsData().then(
      (value) {
        ...
        if (stripeModel.value.isEnabled == true) {
          if (stripeModel.value.clientpublishableKey != '' && stripeModel.value.clientpublishableKey != null) {
            Stripe.publishableKey = stripeModel.value.clientpublishableKey.toString();
            Stripe.merchantIdentifier = 'Foodie Restaurant'.tr;
            Stripe.instance.applySettings();
          }
        }
        log("stripeModel.value.clientpublishableKey :: ${stripeModel.value.toJson()}");
        setRef();
