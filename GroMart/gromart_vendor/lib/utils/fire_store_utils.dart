...
import 'package:store/models/admin_commission.dart';
...
class FireStoreUtils {
  ...
  static Future<List<DocumentModel>> getDocumentList() async {
    ...
    await fireStore.collection(CollectionName.documents).where('type', isEqualTo: "store").where('enable', isEqualTo: true).get().then((value) {
      for (var element in value.docs) {
