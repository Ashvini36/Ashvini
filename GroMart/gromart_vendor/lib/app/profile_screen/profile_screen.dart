...
import 'package:store/app/subscription_plan_screen/subscription_history_screen.dart';
                            ...
                            Visibility(
                              ...
                              child: Padding(
                                ...
                                child: SubscriptionPlanWidget(
                                  onClick: () {
                                    Get.to(const SubscriptionPlanScreen(), arguments: {'isProfile': true})?.then((value) async {
                                      if (value == true) {
