...
import 'package:store/app/subscription_plan_screen/select_payment_screen.dart';
import 'package:store/constant/constant.dart';
import 'package:store/controller/subscription_controller.dart';
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Text(
                                    ...
                                    //         .tr
                                    //     :
                                    "Pay a commission of ${Constant.adminCommission?.commissionType == 'Percent' ? "${Constant.adminCommission?.amount} %" : "${Constant.amountShow(amount: Constant.adminCommission?.amount)} Flat"} on each order"
                                        .tr,
                                    maxLines: 2,
                                    style: TextStyle(
                                      fontSize: 14,
                    ...
                    Divider(
                        color: controller.selectedSubscriptionPlan.value.id == subscriptionPlanModel.id
                            ...
                            : themeChange.getThem()
                                ...
                                : AppThemeData.grey200),
                    const SizedBox(height: 10),
                    Text('Add item limits : ${subscriptionPlanModel.itemLimit == '-1' ? 'Unlimited' : subscriptionPlanModel.itemLimit ?? '0'}',
                        maxLines: 2,
                        ...
                        style: TextStyle(
                            ...
                            color: themeChange.getThem()
                                ...
                                : controller.selectedSubscriptionPlan.value.id == subscriptionPlanModel.id
                                    ...
                                    : AppThemeData.grey900)),
                    const SizedBox(height: 10),
                    Text('Accept order limits : ${subscriptionPlanModel.orderLimit == '-1' ? 'Unlimited' : subscriptionPlanModel.orderLimit ?? '0'}',
