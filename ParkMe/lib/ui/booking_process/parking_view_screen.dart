...
import 'package:parkMe/controller/parking_view_controller.dart';
...
import 'package:parkMe/ui/booking_process/review_summery_screen.dart';
            ...
            body: controller.isLoading.value
                ...
                : Padding(
                    ...
                    child: GridView.builder(
                        itemCount: controller.parkingModel.value.parkingSpace != null && controller.parkingModel.value.parkingSpace!.isNotEmpty
                            ? int.parse(controller.parkingModel.value.parkingSpace.toString())
                            : 0,
                        shrinkWrap: true,
