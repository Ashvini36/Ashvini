                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              child:
                                  ButtonThem.buildButton(context, btnHeight: 40, title: "book_now".tr, btnColor: ConstantColors.primary, txtColor: Colors.white, onPress: () async {
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          Expanded(
                            child: ButtonThem.buildButton(context, btnHeight: 40, title: "book_now".tr, btnColor: ConstantColors.primary, txtColor: Colors.white, onPress: () {
                              List stopsList = [];
