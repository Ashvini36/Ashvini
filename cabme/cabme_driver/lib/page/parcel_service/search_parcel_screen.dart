            ...
            body: Padding(
              ...
              child: Column(
                children: [
                  ...
                  ButtonThem.buildButton(context, title: "Search", btnColor: ConstantColors.primary, txtColor: Colors.white, onPress: () {
                  ...
                  Expanded(
                    ...
                    itemBuilder: (context, index) {
                      return buildHistory(context, controller.searchParcelList[index], controller);
                    },
                  ))
                ],
              ),
                  ...
                  child: Row(
                    children: [
                      Text(
                        ...
                        style: TextStyle(fontSize: 14, color: ConstantColors.subTitleTextColor),
                      ),
                      Text(
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          InkWell(
              onTap: () {
                isSender ? Constant.makePhoneCall(data.senderPhone.toString()) : Constant.makePhoneCall(data.receiverPhone.toString());
              },
              child: Image.asset(
                'assets/icons/call_icon.png',
                height: 36,
