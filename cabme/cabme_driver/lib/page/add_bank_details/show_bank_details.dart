                    ...
                    ? Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: ButtonThem.buildButton(context, btnHeight: 44, title: "Add Bank".tr, btnColor: ConstantColors.primary, txtColor: Colors.white, onPress: () {
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: ButtonThem.buildButton(context, btnHeight: 40, title: "Edit bank".tr, btnColor: ConstantColors.primary, txtColor: Colors.black, onPress: () {
                                  Get.to(AddBankAccount(
                                    isEdit: true,
                                  ))!
                                      .then((value) {
