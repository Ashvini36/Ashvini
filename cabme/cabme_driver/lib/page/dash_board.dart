      ...
      builder: (controller) {
        ...
        return WillPopScope(
          ...
          child: Scaffold(
            appBar: AppBar(
              backgroundColor:
                  controller.selectedDrawerIndex.value == (Constant.parcelActive == "yes" && controller.userModel.value.userData!.parcelDelivery.toString() == "yes" ? 5 : 3)
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: () async {
                              ...
                              } else if (controller.userModel.value.userData!.isVerified == "no" || controller.userModel.value.userData!.isVerified!.isEmpty) {
