const Map<String, String> enUS = {
  ...
  'into_dec_one': "Passengers can choose their desired location and know the time to reach the destination and the amount they need to pay.",
  ...
  'into_dec_three': "Passengers can track their ride and the time required for a cab to arrive and also time to reach the desired destination.",
  'select_profile_photo': "Select a photo for your profile",
  'profile_message': "You must bring out your face and shoulders on the picture. in short we must recognize you through the photo",
  ...
  'Enter the email address we will send an OPT to create new password.': "Enter the email address we will send an OPT to create new password.",
