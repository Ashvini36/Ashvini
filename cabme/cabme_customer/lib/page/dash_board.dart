      ...
      builder: (controller) {
        ...
        return SafeArea(
          child: WillPopScope(
            ...
            child: Scaffold(
              appBar: controller.selectedDrawerIndex.value != 0 && (controller.selectedDrawerIndex.value != (Constant.parcelActive == "yes" ? 7 : 5))
                  ? AppBar(
                      backgroundColor: controller.selectedDrawerIndex.value == (Constant.parcelActive == "yes" ? 8 : 6) ? ConstantColors.primary : ConstantColors.background,
                      elevation: 0,
                      centerTitle: true,
                      title: controller.selectedDrawerIndex.value != 0 && (controller.selectedDrawerIndex.value != (Constant.parcelActive == "yes" ? 7 : 5))
                          ? Text(
