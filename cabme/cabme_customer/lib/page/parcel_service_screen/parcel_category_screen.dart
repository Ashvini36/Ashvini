                  ...
                  controller.isLoading.value
                      ...
                      : Padding(
                          ...
                          child: GridView.builder(
                              gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2, crossAxisSpacing: 15, mainAxisSpacing: 15, mainAxisExtent: 120),
                              itemCount: controller.parcelCategoryList.length,
                              padding: const EdgeInsets.all(8),
                              shrinkWrap: true,
                              physics: const ScrollPhysics(),
                              itemBuilder: (context, index) {
                                return buildItems(item: controller.parcelCategoryList[index], controller: controller);
                              }),
                        )
                ],
              ),
