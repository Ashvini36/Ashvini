        ...
        builder: (controller) {
          return Scaffold(
            ...
            bottomNavigationBar: Padding(
              ...
              child: Row(
                children: [
                  if ((controller.data.value.status.toString() != "new" || controller.data.value.status.toString() != "canceled") &&
                      controller.data.value.idConducteur.toString() != "null")
                    Expanded(
                        child: ButtonThem.buildButton(context,
                            btnHeight: 40,
                            title: controller.data.value.paymentStatus == "yes" ? "paid".tr : "Pay Now".tr,
                            btnColor: controller.data.value.paymentStatus == "yes" ? Colors.green : ConstantColors.primary,
