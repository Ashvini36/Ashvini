              ...
              child: Padding(
                ...
                child: controller.isLoading.value
                    ...
                    : controller.parcelList.isEmpty
                        ? Constant.emptyView(context, "You have not booked any parcel.".tr, false)
                        : ListView.builder(
                            physics: const BouncingScrollPhysics(),
                            itemCount: controller.parcelList.length,
                            shrinkWrap: true,
                            itemBuilder: (context, index) {
                              return buildHistory(context, controller, controller.parcelList[index]);
                            },
                          ),
              ),
            ),
        ...
        if (data.status == "completed") {
          ...
          if (Constant.mapType == "inappmap") {
            ...
            Constant.redirectMap(
              latitude: double.parse(data.latDestination!), //orderModel.destinationLocationLAtLng!.latitude!,
              longLatitude: double.parse(data.lngDestination!), //orderModel.destinationLocationLAtLng!.longitude!,
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Visibility(
                    visible: data.status.toString() == "confirmed" && Constant.rideOtp.toString().toLowerCase() == 'yes'.toLowerCase(),
                    child: Padding(
                          ...
                          Expanded(
                            child: Padding(
                              ...
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text("${data.driverName}", style: const TextStyle(color: Colors.black87, fontWeight: FontWeight.w600)),
                                  StarRating(size: 18, rating: data.moyenne != "null" ? double.parse(data.moyenne.toString()) : 0.0, color: ConstantColors.yellow),
                                ],
                              ),
                            ),
                          ),
