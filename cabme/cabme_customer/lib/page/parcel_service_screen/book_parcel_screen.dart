                ...
                child: Column(
                  children: [
                    ...
                    Padding(
                      ...
                      child: ButtonThem.buildButton(context, title: "Continue".tr, btnColor: ConstantColors.primary, txtColor: Colors.white, onPress: () {
                        if (_key.currentState!.validate()) {
                          if (controller.senderDate.isEmpty || controller.senderTime.isEmpty) {
                            ShowToastDialog.showToast(
                              "Select Sender date and time".tr,
                            );
                          } else if (controller.receiverDate.isEmpty || controller.receiverTime.isEmpty) {
                            ShowToastDialog.showToast("Select receiver date and time".tr);
                          } else if (controller.rPhoneController.text.isEmpty || controller.sPhoneController.text.isEmpty) {
    ...
    return Column(
      children: [
        Row(
          children: [
            Container(
              decoration: BoxDecoration(shape: BoxShape.circle, color: ConstantColors.primary),
              child: const Padding(
          ...
          children: [
              ...
              children: [
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('Sender\'s Address'.tr, style: const TextStyle(fontWeight: FontWeight.w400)),
                      const SizedBox(
                        height: 4,
                      ),
                      Text(
                ...
                ElevatedButton(
                    style: ButtonStyle(
                        foregroundColor: WidgetStateProperty.all<Color>(ConstantColors.primary),
                        backgroundColor: WidgetStateProperty.all<Color>(Colors.white),
                        shape: WidgetStateProperty.all<RoundedRectangleBorder>(
                            RoundedRectangleBorder(borderRadius: const BorderRadius.all(Radius.circular(8)), side: BorderSide(color: ConstantColors.primary)))),
                    onPressed: () async {
                      Get.to(
                        () => PlacePicker(
                          ...
                          onPlacePicked: (result) async {
                            ...
                            controller.senderLocation = LatLng(double.parse(result.geometry!.location.lat.toString()), double.parse(result.geometry!.location.lng.toString()));
            ...
            Padding(
              ...
              child: InternationalPhoneNumberInput(
                onInputChanged: (PhoneNumber number) => controller.sPhoneController.text = number.phoneNumber.toString(),
                ignoreBlank: true,
                    ...
                    children: [
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Text(
                            controller.senderDate.isEmpty ? 'Select Date'.tr : controller.senderDate.toString(),
                          ),
                        ),
                      ),
                      GestureDetector(
                        ...
                        child: Container(
                          decoration: const BoxDecoration(),
                          child: Text(
                            controller.senderTime.isEmpty ? 'Select Time'.tr : controller.senderTime.toString(),
                          ),
                        ),
                      ),
                    ],
        ...
        Column(
          children: [
              ...
              children: [
                Expanded(
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('Receiver\'s Location'.tr, style: const TextStyle(fontWeight: FontWeight.w400)),
                      const SizedBox(
                        height: 4,
                      ),
                      Text(
                        ...
                        MaterialPageRoute(
                          builder: (context) => PlacePicker(
                            ...
                            onPlacePicked: (result) async {
                              ...
                              controller.receiverLocation = LatLng(double.parse(result.geometry!.location.lat.toString()), double.parse(result.geometry!.location.lng.toString()));
            ...
            Padding(
              padding: const EdgeInsets.only(top: 16.0, right: 8.0, left: 8.0),
              child: InternationalPhoneNumberInput(
                onInputChanged: (PhoneNumber number) => controller.rPhoneController.text = number.phoneNumber.toString(),
                ignoreBlank: true,
                autoValidateMode: AutovalidateMode.onUserInteraction,
                // validator: (String? value) {
                //   if (value!.isNotEmpty) {
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      GestureDetector(
                        onTap: () => controller.selectDate(context, isPickUp: false),
                        child: Container(
                          decoration: const BoxDecoration(),
                          child: Text(
                            controller.receiverDate.isEmpty ? 'Select Date'.tr : controller.receiverDate.toString(),
                          ),
                        ),
                      ),
                      GestureDetector(
                        onTap: () => controller.selectTime(context, isPickUp: false),
                        child: Container(
                          decoration: const BoxDecoration(),
                          child: Text(
                            controller.receiverTime.isEmpty ? 'Select Time'.tr : controller.receiverTime.toString(),
                          ),
                        ),
                      ),
                    ],
                    ...
                    itemBuilder: (context, index) {
                      return Padding(
                        ...
                        child: Container(
                          ...
                          height: 100.0,
                          decoration: BoxDecoration(
                            image: DecorationImage(fit: BoxFit.cover, image: FileImage(File(controller.parcelImages[index].path))),
