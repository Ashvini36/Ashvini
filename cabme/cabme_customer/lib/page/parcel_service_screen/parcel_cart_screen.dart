...
class CartParcelScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: GetBuilder<ParcelServiceController>(builder: (controller) {
        return Padding(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                showParcelDetails(
                  title: "Distance".tr,
                  value: controller.distance.toStringAsFixed(int.parse(Constant.decimal.toString())) + Constant.distanceUnit.toString(),
                ),
                showParcelDetails(
                  title: "Duration".tr,
                ...
                showParcelDetails(
                    title: "Total".tr,
                    value: Constant().amountShow(amount: controller.subTotal.toStringAsFixed(int.parse(Constant.decimal.toString()))),
        ...
        children: [
          Row(
            children: [
              ...
              Text(
                isSender ? controller.sNameController.text.toString() : controller.rNameController.text.toString(),
          ...
          Text(
            isSender ? controller.sPhoneController.text.toString() : controller.rPhoneController.text.toString(),
          ...
          // ),
          Text(
            isSender ? controller.senderAddress.toString() : controller.receiverAddress.toString(),
            maxLines: 3,
            style: TextStyle(color: Colors.grey.shade500),
          ),
          Text(
            isSender ? controller.senderDate.toString() : controller.receiverDate.toString(),
            maxLines: 3,
            style: TextStyle(color: Colors.grey.shade500),
          ),
        ],
        ...
        Visibility(
          ...
          child: Padding(
            ...
            child: Card(
              ...
              child: RadioListTile(
                shape:
                    RoundedRectangleBorder(borderRadius: BorderRadius.circular(8), side: BorderSide(color: controller.wallet.value ? ConstantColors.primary : Colors.transparent)),
                controlAffinity: ListTileControlAffinity.trailing,
                value: "Wallet",
                groupValue: controller.paymentMethodType.value,
                onChanged: (String? value) {
        ...
        Visibility(
          ...
          child: Padding(
            ...
            child: Card(
              ...
              child: RadioListTile(
                shape:
                    RoundedRectangleBorder(borderRadius: BorderRadius.circular(8), side: BorderSide(color: controller.stripe.value ? ConstantColors.primary : Colors.transparent)),
                controlAffinity: ListTileControlAffinity.trailing,
                value: "Stripe",
                groupValue: controller.paymentMethodType.value,
                onChanged: (String? value) {
        ...
        Visibility(
          ...
          child: Padding(
            ...
            child: Card(
              ...
              child: RadioListTile(
                shape:
                    RoundedRectangleBorder(borderRadius: BorderRadius.circular(8), side: BorderSide(color: controller.payFast.value ? ConstantColors.primary : Colors.transparent)),
                controlAffinity: ListTileControlAffinity.trailing,
                value: "PayFast",
                groupValue: controller.paymentMethodType.value,
                onChanged: (String? value) {
        ...
        Visibility(
          ...
          child: Padding(
            ...
            child: Card(
              ...
              child: RadioListTile(
                shape:
                    RoundedRectangleBorder(borderRadius: BorderRadius.circular(8), side: BorderSide(color: controller.payTm.value ? ConstantColors.primary : Colors.transparent)),
                contentPadding: const EdgeInsets.symmetric(
                  horizontal: 6,
                ),
                controlAffinity: ListTileControlAffinity.trailing,
        ...
        Visibility(
          ...
          child: Padding(
            ...
            child: Card(
              ...
              child: RadioListTile(
                shape:
                    RoundedRectangleBorder(borderRadius: BorderRadius.circular(8), side: BorderSide(color: controller.paypal.value ? ConstantColors.primary : Colors.transparent)),
                contentPadding: const EdgeInsets.symmetric(
                  horizontal: 6,
                ),
                controlAffinity: ListTileControlAffinity.trailing,
