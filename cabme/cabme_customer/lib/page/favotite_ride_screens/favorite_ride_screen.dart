...
class FavoriteRideScreen extends StatelessWidget {
              ...
              child: RefreshIndicator(
                ...
                child: controller.isLoading.value
                    ...
                    : controller.favouriteList.isEmpty
                        ? Constant.emptyView(context, "You have not any favourite ride".tr, true)
                        : ListView.builder(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              ButtonThem.buildButton(context, btnWidthRatio: 0.3, btnHeight: 35, title: 'delete'.tr, btnColor: ConstantColors.yellow, txtColor: Colors.black, onPress: () {
  ...
  deleteFavDialog(BuildContext context, FavoriteController controller, int index) {
        ...
        controller.deleteFavouriteRide(controller.favouriteList[index].id.toString()).then((value) {
          if (value != null) {
            if (value['success'] == "success") {
              ...
              ShowToastDialog.showToast("Favourite ride delete successfully".tr);
            } else {
