                          ...
                          InkWell(
                            ...
                            child: Padding(
                              ...
                              child: Text(
                                "Add other amount",
                                textAlign: TextAlign.center,
                                style: TextStyle(color: ConstantColors.yellow, decoration: TextDecoration.underline, fontWeight: FontWeight.bold, letterSpacing: 0.8),
                              ),
                            ),
                          ),
                          Padding(
                            padding: const EdgeInsets.only(top: 20, left: 20, right: 20, bottom: 20),
                            child: ButtonThem.buildButton(context, btnHeight: 45, title: "Done", btnColor: ConstantColors.primary, txtColor: Colors.white, onPress: () async {
                              Get.back();
                            }),
                          ),
                        ],
