      ...
      builder: (controller) {
        return Scaffold(
          ...
          appBar: AppBar(
              ...
              elevation: 0,
              centerTitle: true,
              title: Text("Add Complaint".tr, style: const TextStyle(color: Colors.white)),
              leading: Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          Padding(
                            ...
                            child: ButtonThem.buildButton(context, btnHeight: 45, title: "Submit complaint".tr, btnColor: ConstantColors.primary, txtColor: Colors.white,
                                onPress: () async {
                ...
                child: Container(
                  ...
                  child: ClipRRect(
                    ...
                    child: CachedNetworkImage(
                      imageUrl:
                          controller.rideType.value.toString() == "ride" ? controller.rideData.value.photoPath.toString() : controller.parcelData.value.driverPhoto.toString(),
                      height: 110,
                      width: 110,
                      fit: BoxFit.cover,
