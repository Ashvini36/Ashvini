                          ...
                          children: [
                              ...
                              child: Padding(
                                ...
                                child: Text(
                                  "Product prices include a 15% admin commission. For instance, a \$100 product will cost \$115 for the customer. 15% will be applied automatically."
                                      .tr(),
                                  style: TextStyle(
                                      color: isDarkMode(context) ? AppThemeData.danger200 : AppThemeData.danger400,
                                      fontSize: 14,
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      'Select Brand'.tr(),
                                      style: TextStyle(
                                          color: isDarkMode(context) ? Colors.white : Colors.black, fontWeight: FontWeight.bold, fontSize: 16),
                                    ),
                                  ),
                                                    ...
                                                    if (result != null) {
                                                      ...
                                                      if (sizeInMb <= double.parse(fileSize)) {
                                                        ...
                                                        final snackBar = SnackBar(
                                                          content:
                                                              Text('${"Please select less than ".tr()}${fileSize.toString()}  ${"mb file.".tr()}')
                                                                  .tr(),
                                                        );
                                                      ...
                                                      ScaffoldMessenger.of(context)
                                                          .showSnackBar(SnackBar(content: Text("Please select zip file!".tr())));
                            ...
                            Visibility(
                              ...
                              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                ...
                                Theme(
                                  data: ThemeData(bottomSheetTheme: BottomSheetThemeData(backgroundColor: Colors.white)),
                                                    ...
                                                    InkWell(
                                                      onTap: () {
                                                        _displayTextInputDialog(
                                                            context, index, itemAttributes!.attributes![index].attributesId.toString());
                                                      },
                                                      child: Icon(
                                                        Icons.add,
                                                        color: Color(COLOR_PRIMARY),
                                                            ...
                                                            setState(() {
                                                              ...
                                                              if (listArary.length > 0) {
                                                                ...
                                                                list.forEach((element) {
                                                                  bool _productIsInList =
                                                                      itemAttributes!.variants!.any((product) => product.variant_sku == element);
                                                                  if (_productIsInList) {
                                                                    Variants variant = itemAttributes!.variants!
                                                                        .firstWhere((product) => product.variant_sku == element);
                                              ...
                                              children: [
                                                Row(
                                                  children: [
                                                    ...
                                                    Expanded(
                                                      child: itemAttributes!.variants![index].variant_image != null &&
                                                              itemAttributes!.variants![index].variant_image!.isNotEmpty
                                                          ? InkWell(
                                                              onTap: () {
                            ...
                            Padding(
                                ...
                                child: Text(
                                  'Price'.tr(),
                                  style:
                                      TextStyle(color: isDarkMode(context) ? Colors.white : Colors.black, fontWeight: FontWeight.bold, fontSize: 16),
                                )),
                            Padding(
                              padding: const EdgeInsets.symmetric(vertical: 5),
                              child: Row(
          ...
          onPressed: () async {
            ...
            if (singleImage != null) {
              ...
              String image = await FireStoreUtils.uploadUserImageToFireStorage(
                  File(singleImage.path), itemAttributes!.variants![index].variant_id.toString() ?? '');
                            ...
                            list.forEach((element) {
                              ...
                              if (_productIsInList) {
                                ...
                                if (itemAttributes!.attributes![index].attributeOptions!.length == 1) {
                                  itemAttributes!.variants!.clear();
                                  Variants variantsModel = Variants(
                                      variant_sku: element, variant_id: Uuid().v1(), variant_image: "", variant_price: "0", variant_quantity: "-1");
                                  itemAttributes!.variants!.add(variantsModel);
                                } else {
                                  Variants variantsModel = Variants(
                                      variant_sku: element, variant_id: Uuid().v1(), variant_image: "", variant_price: "0", variant_quantity: "-1");
